...
# VGG19-BN Back-End architecture
# Based on Torchvision implementation in
...
class VGGBackEnd(nn.Module):
    ...
    def _make_layer(self):
        layers = []
        in_channels = 64
        config = [64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M', 512, 512, 512, 512, 'M']
        for v in config:
            if v == 'M':
...
# DenseNet121 Back-End architecture
# Based on Torchvision implementation in
# https://github.com/pytorch/vision/blob/master/torchvision/models/densenet.py
class _DenseLayer(nn.Module):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate, memory_efficient=False) -> None:
